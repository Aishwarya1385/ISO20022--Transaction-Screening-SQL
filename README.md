...
---
    END
) AS value_at_compliance_risk# ISO20022--Transaction-Screening-SQL
An SQL analytics and compliance engine simulating risk screening workflows across ISO 20022 payment pipelines.
